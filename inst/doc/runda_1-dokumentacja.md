...
Na podstawie zbioru z badania absolwentów (*MLEZAiMD_absolwent_n2959_20171013.sav*) funkcja `wczytaj_wyniki_pilrm()` zwraca listę ramek danych (zbiorów) zawierającą następujące elementy:
