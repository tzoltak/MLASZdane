if (file.exists("MLEZAiMD_I_runda_CAPI_absolwent_n7713_20180924_z_wagami_z_kodowaniem.sav")) {
  ...
  test_that("oblicz_wskazniki_ind_1r()", {
    ...
    nazwy = c('ID_RESP', 'SZK_typ', 'SZK_kod', 'SZK_pozycja_w_operacie',
              ...
              'pg2h.1_pierwsza', 'pg2h.2_pierwsza', 'pg2h.3_pierwsza',
              'pg2h.4_pierwsza', 'pg2h.5_pierwsza', 'pg2h.6_pierwsza',
              'pg2h.7_pierwsza', 'pg2h.8_pierwsza', 'pg2h.9_pierwsza',
              'pg2h.10_pierwsza', 'pg2i.1_pierwsza', 'pg2i.2_pierwsza',
              'pg2i.3_pierwsza', 'pg2i.9_pierwsza',
              ...
              'pg2h.1_ostatnia', 'pg2h.2_ostatnia', 'pg2h.3_ostatnia',
              'pg2h.4_ostatnia', 'pg2h.5_ostatnia', 'pg2h.6_ostatnia',
              'pg2h.7_ostatnia', 'pg2h.8_ostatnia', 'pg2h.9_ostatnia',
              'pg2h.10_ostatnia', 'pg2i.1_ostatnia', 'pg2i.2_ostatnia',
              'pg2i.3_ostatnia', 'pg2i.9_ostatnia',
              'pg2h.1_6m', 'pg2h.2_6m', 'pg2h.3_6m', 'pg2h.4_6m', 'pg2h.5_6m',
              'pg2h.6_6m', 'pg2h.7_6m', 'pg2h.8_6m', 'pg2h.9_6m', 'pg2h.10_6m',
              'pg2i.1_6m', 'pg2i.2_6m', 'pg2i.3_6m', 'pg2i.9_6m',
              'pg2h.1_9m', 'pg2h.2_9m', 'pg2h.3_9m', 'pg2h.4_9m', 'pg2h.5_9m',
              'pg2h.6_9m', 'pg2h.7_9m', 'pg2h.8_9m', 'pg2h.9_9m', 'pg2h.10_9m',
